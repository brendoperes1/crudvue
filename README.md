...
### Para rodar a resolução ###

* Executar: npm i axios
* Executar: npm i json-server -g
* Para funcionar os dois ambientes devem estar funcionando, tanto o npm run serve quanto o json-server company.json (que é utilizado para simular a api)